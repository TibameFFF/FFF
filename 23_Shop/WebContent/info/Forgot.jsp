								...
								<div class="col-lg">
									<div class="p-5">
										<div class="text-center">
											...
											<p class="mb-4">請輸入你的帳號，我們會寄信到您電子信箱重製的密碼!</p>
										</div>
										<form class="user" method="post" action="<%=request.getContextPath()%>/Forgot">
											<div class="form-group">
												<input type="text" class="form-control form-control-user" name="account" placeholder="輸入帳號">
											</div>
											<br> 
											<input class="btn btn-primary btn-user btn-block" id="login-btn" type="submit" value="重置密碼" >
											<div>
