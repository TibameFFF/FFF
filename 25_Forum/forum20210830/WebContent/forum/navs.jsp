...
<body>
	...
	<div class="main">
		...
		<div class="navs">
			<div class="container">
				<div class="navs_menu">
					<a href="navs.html" class="font-weight-bold">運動</a>
			...
			<div class="result_container">
				<div class="content">
					<div class="result_title">
						<div class="row h-100">
							<div class="col-5">
								<div class="result_">主題：<b>運動</b></div>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
                    ...
                    <div class="result_content">
						<div class="row">
							<div class="col-5">
								<a href="navs_content.html" class="text-truncate">羽球正手拍心得</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">籃球NBA季後賽 湖人VS公牛</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">足球的由來</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">羽毛球雙人對打訣竅</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">運動過後的肌肉酸痛解決辦法</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">運動與蛋白質的密切關係</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">排球規則</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">如何稱為棒球裁判</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
							...
							<div class="col-5">
								<a href="" class="text-truncate">摔角規則</a>
							</div>
							<div class="col-7">
								<div class="row">
									<div class="col">
