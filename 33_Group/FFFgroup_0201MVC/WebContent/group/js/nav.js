  ...
  <div class="collapse navbar-collapse" id="navbarsExample04">
    <ul class="navbar-nav me-auto mb-2 mb-md-0">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown04">
          <li><a class="dropdown-item" href="groupsearch.jsp">參加揪團</a></li>
          <li><a class="dropdown-item" href="groupagree.jsp">發起揪團</a></li> 
          <li><a class="dropdown-item" href="groupofuser.jsp">我的揪團</a></li>
    ...
    <div>
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li  class="nav-item">   
            <a class="nav-link" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24.325 25.625">
                    <path id="Icon_material-notifications" data-name="Icon material-notifications" d="M18.163,29.375A2.866,2.866,0,0,0,21.2,26.747H15.122A2.856,2.856,0,0,0,18.163,29.375Zm9.122-7.885V14.92a8.21,8.21,0,0,0-6.841-8.305V5.721a2.14,2.14,0,0,0-2.28-1.971,2.14,2.14,0,0,0-2.28,1.971v.894A8.187,8.187,0,0,0,9.041,14.92V21.49L6,24.119v1.314H30.325V24.119Z" transform="translate(-6 -3.75)" fill="#fff"/>
                </svg>                              
            </a>      
            </li>
            <li  class="nav-item">
            <a class="nav-link" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 34.875 34.875">
                    <path id="Icon_awesome-user-circle" data-name="Icon awesome-user-circle" d="M17.438.563A17.438,17.438,0,1,0,34.875,18,17.434,17.434,0,0,0,17.438.563Zm0,6.75A6.188,6.188,0,1,1,11.25,13.5,6.188,6.188,0,0,1,17.438,7.313Zm0,24.188a13.474,13.474,0,0,1-10.3-4.8,7.839,7.839,0,0,1,6.926-4.2,1.72,1.72,0,0,1,.5.077,9.309,9.309,0,0,0,2.876.485,9.274,9.274,0,0,0,2.876-.485,1.72,1.72,0,0,1,.5-.077,7.839,7.839,0,0,1,6.926,4.2A13.474,13.474,0,0,1,17.438,31.5Z" transform="translate(0 -0.563)" fill="#fff"/>
                </svg>
            </a>      
            </li>
        </ul>
