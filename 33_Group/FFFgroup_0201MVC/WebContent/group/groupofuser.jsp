...
<%
	...
	List<GroupVO> list1 = groupSvc.getMyGroup(1,1);//放user_id 跟 活動狀態
	pageContext.setAttribute("list1",list1);
	
	List<GroupVO> list2 = groupSvc. getMyGroup(1,2);
	pageContext.setAttribute("list2",list2);
	
	List<GroupVO> list3 = groupSvc.getMyGroup(1,3);
	pageContext.setAttribute("list3",list3);
	
	List<GroupVO> list0 = groupSvc.getMyGroup(1,0);
