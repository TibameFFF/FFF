...
<%
    ...
    List<GroupVO> list1 = groupSvc.getAllFromState_no(1);//放user_id 跟 狀態
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <table class="table table-hover">
                           ...
                           <c:forEach var="groupVO1" items="${list1}">                                                                             
                              <tr> 
                              	<td><b>${groupVO1.g_no}</b></td>
                                <td>${groupVO1.g_name}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><FORM METHOD="post" ACTION="group.do" enctype="multipart/form-data">
                                          		<input type="submit" class="dropdown-item" value="詳細資訊">
                                          		<input type="hidden" name="g_no" value="${groupVO1.g_no}">
	        								   	<input type="hidden" name="action" value="getOne_For_Display"></FORM></li>
                                          <li><a class="dropdown-item" href="#">加入聊天室</a></li>
                                          <li><hr class="dropdown-divider"></li>
                                          <li><FORM METHOD="post"  ACTION="<%=request.getContextPath()%>/group/group.do" enctype="multipart/form-data"style="margin-bottom: 0px;">
										     <input type="submit"  class="dropdown-item" value="編輯揪團">
										     <input type="hidden" name="g_no"  value="${groupVO1.g_no}">
										     <input type="hidden" name="action" 	value="getOne_For_Update"></FORM></li>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="2-tab">
                        ...
                        <table class="table table-hover">
							...
							<c:forEach var="groupVO2" items="${list2}">
                              <tr>
                              	<td><b>${groupVO2.g_no}</b></td>
                                <td>${groupVO2.g_name}</td>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="3-tab">
                        ...
                        <table class="table table-hover">
 						...
 						<c:forEach var="groupVO3" items="${list3}"> 
                              <tr>
                              	<td><b>${groupVO3.g_no}</b></td>
                                <td>${groupVO3.g_name}</td>
                 ...
                 <div class="tab-pane fade" id="zero" role="tabpanel" aria-labelledby="0-tab">
                        ...
                        <table class="table table-hover">
 						...
 						<c:forEach var="groupVO0" items="${list0}"> 
                              <tr>
                              	<td><b>${groupVO0.g_no}</b></td>
                                <td>${groupVO0.g_name}</td>
