...
//		"SELECT * FROM group1.group where g_no=?";
	...
	private static final String GET_STATE_NO = 
			"SELECT g_no, g_name, g_type_no, g_content, g_start_time, g_end_time, apply_start_time, apply_end_time, place, number_lower, number_upper, number_total, user_id, introduce, phone, email, state_no, g_flow_cause, photo, g_url FROM group1.group  WHERE state_no = ?;";
	...
	"select * from group1.group where  g_no=any(select g_no from group1.member where user_id= ?)and state_no= ? ";	
	...
	public List<GroupVO> getAllFromState_no(Integer state_no) {
		...
		try {
			...
			Class.forName(driver);
			con = DriverManager.getConnection(url, userid, passwd);
			pstmt = con.prepareStatement(GET_STATE_NO);
			pstmt.setInt(1, state_no);
			rs = pstmt.executeQuery();
	...
	public List<GroupVO> findMyGroups(Integer user_id) {
		...
		try {
			...
			Class.forName(driver);
			con = DriverManager.getConnection(url, userid, passwd);
			pstmt = con.prepareStatement(GET_MY_GROUPS);
...
//		List<GroupVO> list1 = dao.getMyGroup(1,1);
//		for (GroupVO bgroup : list1) {
//			System.out.print(bgroup.getG_no() + ",");
//			System.out.print(bgroup.getG_name() + ",");
//			System.out.print(bgroup.getG_type_no() + ",");
//			System.out.print(bgroup.getG_content() + ",");
//			System.out.print(bgroup.getG_start_time() + ",");
//			System.out.print(bgroup.getG_end_time() + ",");
//			System.out.print(bgroup.getApply_start_time() + ",");
//			System.out.print(bgroup.getApply_end_time() + ",");
//			System.out.print(bgroup.getPlace() + ",");
//			System.out.print(bgroup.getNumber_lower() + ",");
//			System.out.print(bgroup.getNumber_upper() + ",");
//			System.out.print(bgroup.getNumber_total() + ",");
//			System.out.print(bgroup.getUser_id() + ",");
//			System.out.print(bgroup.getIntroduce() + ",");
//			System.out.print(bgroup.getPhone() + ",");
//			System.out.print(bgroup.getEmail() + ",");
//			System.out.print(bgroup.getState_no() + ",");
//			System.out.print(bgroup.getG_flow_cause() + ",");
//			System.out.print(bgroup.getPhoto() + ",");
//			System.out.print(bgroup.getG_url() + ","); 	
//			System.out.println();					
//		}
