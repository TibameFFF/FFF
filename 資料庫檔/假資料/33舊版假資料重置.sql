...
DELETE FROM `group1`.`reply`;
ALTER TABLE `group1`.`reply` AUTO_INCREMENT=0;

DELETE FROM `group1`.`type`;
ALTER TABLE `group1`.`type` AUTO_INCREMENT=0;
