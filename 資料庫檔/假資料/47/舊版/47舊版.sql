...
INSERT INTO `BACK`.`ADMIN` (`ADMIN_ID`,`ADMIN_ACCOUNT`,`ADMIN_PASSWORD`,`ADMIN_NAME`,`ADMIN_JOIN`,`ADMIN_LEVEL`,`ADMIN_STATUS`) VALUES (3,'test','test','test','2020-12-11 11:11:11.0',1,1);
      --            
INSERT INTO `BACK`.`ARTICLE_REPORT` (`REPORT_NO`,`REPORTER_ID`,`ARTICLE_ID`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,1,1,6,1,'廢文','2020-12-11 11:11:11.0');
INSERT INTO `BACK`.`REPLY_REPORT` (`REPORT_NO`,`REPORTER_ID`,`REPLY_ID`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,1,1,8,1,'歧視原住民qq','2020-12-15 11:11:11.0');
INSERT INTO `BACK`.`GROUP_REPORT` (`REPORT_NO`,`REPORTER_ID`,`GROUP_ID`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,1,1,2,1,'糾人尋仇','2020-12-12 11:11:11.0');
INSERT INTO `BACK`.`SINGLECHAT_REPORT` (`REPORT_NO`,`REPORTER_ID`,`MESSAGE_NO`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,1,1,3,1,'騷擾','2020-12-13 11:11:11.0');
INSERT INTO `BACK`.`GROUPCHAT_REPORT` (`REPORT_NO`,`REPORTER_ID`,`MESSAGE_NO`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,1,1,6,2,'貼亂碼亂群','2020-12-14 11:11:11.0');
INSERT INTO `BACK`.`INTRO_REPORT` (`REPORT_NO`,`REPORTER_ID`,`REPORTED_ID`,`REPORT_TYPE`,`REPORT_STATUS`,`REPORT_DESCRIPTION`,`REPORT_TIME`) VALUES (1,2,1,10,3,'假人','2020-12-15 11:11:11.0');
